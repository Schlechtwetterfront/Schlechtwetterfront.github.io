...
'''),
        Section('ATRB Calculator', 'atrb-calculator', True, False, False, '''
Use this to calculate flag values, convert render type and data values to hex and convert from and to the .msh ATRB hex chunk.

Note that Single-sided and Double-sided Transparency are exclusive, so selecting both might not have the desired/any effect. Check out the [ATRB](msh.html#ATRB){{: .bordered .block}} chunk for more information on each flag.
